...
class RussiaSpecProvider(BaseSpecProvider):
    ...
    def _get_years_of_issue(
        ...
        last_issue_last_two_digits: int = year_of_last_issue % 100
    ...
    def kpp(
        ...
        include_foreign_organizations_codes: bool = True,
    ) -> str:
        ...
        :Example:
            560058652.
        """
        russian_registration_reasons: t.Final[
            t.Sequence[str]
        ] = (  # 02, 03, 04, 05, 31, 32 are legacy codes and don't apply to new KPPs.
            "01",
            "02",
            "03",
            "04",
        ...
        if not registration_reason_codes:
            warn(
                "KPP cannot be generated without a registration reason code, the setting will be ignored."
            )
            registration_reason_codes.extend(russian_registration_reasons)
            registration_reason_codes.extend(foreign_registration_reasons)
